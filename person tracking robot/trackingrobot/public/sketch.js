...
function setup() {
  ...
  poseNet.on("pose", function (results) {
    ...
    if (confidenceTest(poseList)) {
      //updates the poses field for the canvas drawing if requirements are met
      poses = results;
      let coordinates = {
        left: {
          shoulder: {
